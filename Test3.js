...
import { AppRegistry, Animated, Dimensions, Easing, ImageBackground, Text, View, StyleSheet, TouchableOpacity,CategoryLinks, ScrollView } from 'react-native';
...
const categoryTouts = [ //the touts are the clickable image items that hold our links
    { image: require('./logo.png'), title: 'Category1', links: categoryLinks },
    { image: require('./logo.png'), title: 'Category2', links: categoryLinks },
    { image: require('./logo.png'), title: 'Category3', links: categoryLinks },
]
...
export class Test3 extends React.PureComponent { //using PureComponent will prevent unnecessary renders
